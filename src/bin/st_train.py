...
def main():
    ...
    parser.add_argument('--asr', default=0.0, type=float, nargs='?',
                        help='Weight for ASR task')
    parser.add_argument('--asr-type', default='ctc', type=str,
                        choices=['att', 'ctc'],
                        help='att or ctc')
    parser.add_argument('--mt', default=0.0, type=float, nargs='?',
                        help='Weight for MT task')
    parser.add_argument('--input-feeding', default=False, nargs='?',
                        help='Input-feeding approach')
