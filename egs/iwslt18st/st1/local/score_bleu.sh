...
local/json2trn_mt.py ${dir}/data.json ${dic} ${dir}/hyp.de.trn
...
### case-insensitive
# segment hypotheses with RWTH tool
segmentBasedOnMWER.sh $xml_en $xml_de ${dir}/hyp.de.wrd.trn.detok $system de ${dir}/hyp.no-case.wrd.trn.detok.sgm.xml "" 0
sed -e "/<[^>]*>/d" ${dir}/hyp.no-case.wrd.trn.detok.sgm.xml > ${dir}/hyp.no-case.wrd.trn.detok.sgm

multi-bleu-detok.perl -lc ${dir}/ref.de.wrd.trn < ${dir}/hyp.no-case.wrd.trn.detok.sgm > ${dir}/result.no-case.wrd.txt
